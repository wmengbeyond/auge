...
<script>
    ...
    function bootstrapValidatorInit() {
        $("#brand_form,#brand_form_edit").bootstrapValidator({
    ...
    function editAction() {
        $('#edit_modal_submit').click(
            function () {
                $('#brand_form_edit').data('bootstrapValidator').validate();
                if (!$('#brand_form_edit').data('bootstrapValidator').isValid()) {
                    return;
                }

                var status = 0;
                var val=$('input:radio[name="radio_edit"]:checked').val();
                if (val == '1') {
                    status = 1;
                } else {
                    status = 0;
                ...
                var index = $('select[name="type_select"]')[0].selectedIndex;
                var type = $('select[name="type_select"]').val(); // 选中值
    ...
    function addAction() {
        ...
        $('#add_modal_submit').click(function () {
            var status = 0;
            var val=$('input:radio[name="radio_add"]:checked').val();
            if (val == '启用') {
                status = 1;
            } else {
                status = 0;
            ...
            var index = $('select[name="add_type"]')[0].selectedIndex;
            var type = $('select[name="add_type"]').val(); // 选中值
            var person = '${sessionScope.userInfo.userName}';

            var data = {
                name: $('#add_name').val(),
                type: type,
                changjia: $('#add_changjia').val(),
                status: status,
                mperson: person,
                cperson: person
            }
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    $('#goods_size').val("");
                    $('#goods_value').val("");
                    $('#brand_form').bootstrapValidator("resetForm", true);
                },
                error: function (xhr, textStatus, errorThrow) {
                    $('#add_modal').modal("hide");
                    // handler error
    ...
    function rowEditOperation(row) {
        ...
        // load info
        $('#brand_form_edit').bootstrapValidator("resetForm", true);
        $('#name_edit').val(row.name);
        $('#type_select').val(row.type);
        $('#changjia_edit').val(row.changjia);

        if (1 == row.status) {
            $($("input[name='radio_edit']").eq(0)).iCheck('check');
        } else {
            $($("input[name='radio_edit']").eq(1)).iCheck('check');
        }
    }
    ...
    function exportAction() {
        ...
        $('#export_download').click(function(){
            ...
            var url = "brandManage/exportBrand?" + $.param(data)
...
<div class="box box-primary">
                ...
                <div class="tab-pane active" id="tab_1">
                    <div class="row margin">
                        <div class="form-inline">
                            ...
                            <input type="text" id="key_word" class="form-control" placeholder="品牌名称">
    ...
    <div class="box-footer">
        <div class="row">
            <div class="col-md-12">
                <table class="table table-striped table-bordered table-hover" id="brandTable"></table>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">导入品牌信息</h4>
            </div>
            <div class="modal-body">
                <div id="step1">
                    <div class="row" style="margin-top: 15px">
                        ...
                        <div class="col-md-10 col-sm-10">
                            <div>
                                <h4>点击下面的下载按钮，下载品牌信息电子表格</h4>
                            </div>
                            <div style="margin-top: 30px; margin-buttom: 15px">
                                <a class="btn btn-info"
                                   href="commons/fileSource/download/brandInfo.xlsx"
                ...
                <div id="step2" class="hide">
                    <div class="row" style="margin-top: 15px">
                        ...
                        <div class="col-md-10 col-sm-10">
                            <div>
                                <h4>请按照品牌信息电子表格中指定的格式填写需要添加的一个或多个品牌信息</h4>
                            </div>
                ...
                <div id="step3" class="hide">
                    <div class="row" style="margin-top: 15px">
                        ...
                        <div class="col-md-8 col-sm-10">
                            <div>
                                <div>
                                    <h4>请点击下面上传文件按钮，上传填写好的品牌信息电子表格</h4>
                                </div>
                                <div style="margin-top: 30px; margin-buttom: 15px">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button class="close" type="button" data-dismiss="modal"
                        aria-hidden="true">&times;</button>
                <h4 class="modal-title" id="myModalLabelexport">导出品牌信息</h4>
            </div>
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-8 col-sm-8">
                        <h3>是否确认导出品牌信息</h3>
                        <p>(注意：请确定要导出的品牌信息，导出的内容为当前列表的搜索结果)</p>
                    </div>
                </div>
            </div>
            <div class="modal-footer">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabelAdd">添加品牌信息</h4>
            </div>
            <div class="modal-body">
                <!-- 模态框的内容 -->
                <div class="row">
                    <div class="col-md-1 col-sm-1"></div>
                    <div class="col-md-8 col-sm-8">
                        <form class="form-horizontal" role="form" id="brand_form"
                              style="margin-top: 25px">
                            <div class="form-group">
                                <label class="control-label col-md-4 col-sm-4"> <span>品牌名称：</span>
                                </label>
                                <div class="col-md-8 col-sm-8">
                                    <input type="text" class="form-control" id="add_name"
                                           name="add_name" placeholder="品牌名称">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-4 col-sm-4"> <span>品牌类型：</span>
                                </label>
                                <div class="col-md-8 col-sm-8">
                                    <select name="add_type" class="form-control">
                                        <option name="0">自有品牌</option>
                                        <option name="1">代理品牌</option>
                                        <option name="2">同质配套</option>
                                        <option name="3">无</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-4 col-sm-4"> <span>品牌厂家：</span>
                                </label>
                                <div class="col-md-8 col-sm-8">
                                    <input type="text" class="form-control" id="add_changjia"
                                           name="add_changjia" placeholder="品牌厂家">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-8 col-sm-8">
                                    <div class="row">
                                        <label class="col-md-4 col-sm-4">
                                            <input type="radio" name="radio_add" class="square-green" value="启用" checked>
                                            启用
                                        </label>
                                        <label class="col-md-4 col-sm-4">
                                            <input type="radio" name="radio_add" class="square-green" value="禁用">
                                            禁用
                                        </label>
                                    </div>
                                </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabelEdit">商品品牌信息</h4>
            </div>
            <div class="modal-body">
                <!-- 模态框的内容 -->
                <div class="row">
                    <div class="col-md-1 col-sm-1"></div>
                    <div class="col-md-8 col-sm-8">
                        <form class="form-horizontal" role="form" id="brand_form_edit"
                              style="margin-top: 25px">
                            <div class="form-group">
                                <label class="control-label col-md-4 col-sm-4"> <span>品牌名称：</span>
                                </label>
                                <div class="col-md-8 col-sm-8">
                                    <input type="text" class="form-control" id="name_edit"
                                           name="name_edit" placeholder="品牌名称">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-4 col-sm-4"> <span>品牌类型：</span>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8 col-sm-8">
                                    <input type="text" class="form-control" id="changjia_edit"
                                           name="changjia_edit" placeholder="品牌厂家">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-4 col-sm-4"> <span>状态：</span>
                                ...
                                <div class="col-md-8 col-sm-8">
                                    <div class="row">
                                        <label class="col-md-4 col-sm-4">
                                            <input type="radio" name="radio_edit" class="square-green" value="1">
                                            启用
                                        </label>
                                        <label class="col-md-4 col-sm-4">
                                            <input type="radio" name="radio_edit" class="square-green" value="0">
                                            禁用
                                        </label>
                                    </div>
                                </div>
