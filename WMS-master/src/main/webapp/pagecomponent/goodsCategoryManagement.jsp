...
<script>
    ...
    function bootstrapValidatorInit() {
        $("#goodsCategory_form,#goodsCategory_form_edit").bootstrapValidator({
    ...
    function editAction() {
        $('#edit_modal_submit').click(
            function () {
                $('#goodsCategory_form_edit').data('bootstrapValidator').validate();
                if (!$('#goodsCategory_form_edit').data('bootstrapValidator').isValid()) {
                    return;
                }
                ...
                $.ajax({
                    type: "POST",
                    url: 'goodsCategoryManage/updateGoodsCategory',
                    dataType: "json",
    ...
    function deleteAction() {
        $('#delete_confirm').click(function () {
            ...
            $.ajax({
                type: "GET",
                url: "goodsCategoryManage/deleteGoodsCategory",
                dataType: "json",
                contentType: "application/json",
                data: data,
                success: function (response) {
    ...
    function addAction() {
        ...
        $('#add_modal_submit').click(function () {
            ...
            $.ajax({
                type: "POST",
                url: "goodsCategoryManage/addGoodsCategory",
                dataType: "json",
                contentType: "application/json",
                data: JSON.stringify(data),
                success: function (response) {
                    ...
                    $('#goods_size').val("");
                    $('#goods_value').val("");
                    $('#goodsCategory_form').bootstrapValidator("resetForm", true);
                },
                error: function (xhr, textStatus, errorThrow) {
                    $('#add_modal').modal("hide");
                    // handler error
    ...
    function baseTableInit() {
        $('#goodsCategoryTable').bootstrapTable({
            columns: [{
                field: 'id',
                title: '序号'
            }, {
            ...
            url: 'goodsCategoryManage/getGoodsCategoryList',
    ...
    function tableRefresh() {
        $('#goodsCategoryTable').bootstrapTable('refresh', {
            query: {}
        });
    }
    ...
    function rowEditOperation(row) {
        ...
        // load info
        $('#goodsCategory_form_edit').bootstrapValidator("resetForm", true);
    ...
    function importAction() {
        ...
        $('#submit').click(function() {
            ...
            // ajax
            $.ajaxFileUpload({
                url : "goodsCategoryManage/importGoodsCategory",
                secureuri: false,
                dataType: 'json',
                fileElementId:"file",
    ...
    function exportAction() {
        ...
        $('#export_download').click(function(){
            ...
            var url = "goodsCategoryManage/exportGoodsCategory?" + $.param(data)
...
<div class="box box-primary">
                ...
                <div class="tab-pane active" id="tab_1">
                    <div class="row margin">
                        <div class="form-inline">
                            ...
                            <input type="text" id="key_word" class="form-control" placeholder="类别名称">
    ...
    <div class="box-footer">
        <div class="row">
            <div class="col-md-12">
                <table class="table table-striped table-bordered table-hover" id="goodsCategoryTable"></table>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">导入类别信息</h4>
            </div>
            <div class="modal-body">
                <div id="step1">
                    <div class="row" style="margin-top: 15px">
                        ...
                        <div class="col-md-10 col-sm-10">
                            <div>
                                <h4>点击下面的下载按钮，下载类别信息电子表格</h4>
                            </div>
                            <div style="margin-top: 30px; margin-buttom: 15px">
                                <a class="btn btn-info"
                                   href="commons/fileSource/download/goodsCategoryInfo.xlsx"
                ...
                <div id="step2" class="hide">
                    <div class="row" style="margin-top: 15px">
                        ...
                        <div class="col-md-10 col-sm-10">
                            <div>
                                <h4>请按照类别信息电子表格中指定的格式填写需要添加的一个或多个类别信息</h4>
                            </div>
                ...
                <div id="step3" class="hide">
                    <div class="row" style="margin-top: 15px">
                        ...
                        <div class="col-md-8 col-sm-10">
                            <div>
                                <div>
                                    <h4>请点击下面上传文件按钮，上传填写好的类别信息电子表格</h4>
                                </div>
                                <div style="margin-top: 30px; margin-buttom: 15px">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button class="close" type="button" data-dismiss="modal"
                        aria-hidden="true">&times;</button>
                <h4 class="modal-title" id="myModalLabelexport">导出类别信息</h4>
            </div>
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-8 col-sm-8">
                        <h3>是否确认导出类别信息</h3>
                        <p>(注意：请确定要导出的类别信息，导出的内容为当前列表的搜索结果)</p>
                    </div>
                </div>
            </div>
            <div class="modal-footer">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabelAdd">添加类别信息</h4>
            </div>
            <div class="modal-body">
                <!-- 模态框的内容 -->
                <div class="row">
                    <div class="col-md-1 col-sm-1"></div>
                    <div class="col-md-8 col-sm-8">
                        <form class="form-horizontal" role="form" id="goodsCategory_form"
                              style="margin-top: 25px">
                            <div class="form-group">
                                <label class="control-label col-md-4 col-sm-4"> <span>类别名称：</span>
                                </label>
                                <div class="col-md-8 col-sm-8">
                                    <input type="text" class="form-control" id="add_name"
                                           name="add_name" placeholder="类别名称">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-4 col-sm-4"> <span>类别类型：</span>
                                </label>
                                <div class="col-md-8 col-sm-8">
                                    <select name="add_type" class="form-control">
                                        <option name="0">类别一级</option>
                                        <option name="1">类别二级</option>
                                        <option name="2">类别三级</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabelEdit">商品类别信息</h4>
            </div>
            <div class="modal-body">
                <!-- 模态框的内容 -->
                <div class="row">
                    <div class="col-md-1 col-sm-1"></div>
                    <div class="col-md-8 col-sm-8">
                        <form class="form-horizontal" role="form" id="goodsCategory_form_edit"
                              style="margin-top: 25px">
                            <div class="form-group">
                                <label class="control-label col-md-4 col-sm-4"> <span>类别名称：</span>
                                </label>
                                <div class="col-md-8 col-sm-8">
                                    <input type="text" class="form-control" id="name_edit"
                                           name="name_edit" placeholder="类别名称">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-4 col-sm-4"> <span>类别类型：</span>
